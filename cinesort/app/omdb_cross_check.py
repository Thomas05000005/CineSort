...
# Cf PR #285 (pattern identique cote omdb_client) : la regex etait recompilee
# a chaque appel, et `import re/unicodedata` etait lazy dans la fonction.
_ALPHANUM_STRIP_RE = re.compile(r"[^a-z0-9]")
...
def _normalize_title_for_compare(title: str) -> str:
    ...
    return _ALPHANUM_STRIP_RE.sub("", s)
