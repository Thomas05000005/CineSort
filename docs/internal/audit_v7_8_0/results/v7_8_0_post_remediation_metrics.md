...
| Métrique | Valeur |
|----------|--------|
| Fonctions test_* totales | 4203 |
| Tests skip cumulés (@skip / @unittest.skip) | 33 |
...
| `cinesort/ui/api/apply_support.py` | `_execute_apply` | 1032 | **227L** |
| `cinesort/ui/api/apply_support.py` | `_execute_undo_ops` | 283 | **207L** |
| `cinesort/app/plan_support.py` | `_plan_item` | 1580 | **182L** |
| `cinesort/domain/quality_score.py` | `compute_quality_score` | 1258 | **181L** |
...
| `cinesort/domain/quality_score.py` | `_score_video` | 447 | **178L** |
...
| `cinesort/ui/api/apply_support.py` | `apply_changes` | 1636 | **152L** |
...
| `cinesort/ui/api/apply_support.py` | `build_apply_preview` | 1853 | 151L |
| `cinesort/ui/api/run_flow_support.py` | `_build_plan_job_fn` | 324 | 148L |
| `cinesort/app/job_runner.py` | `_run_worker` | 186 | 144L |
| `cinesort/ui/api/apply_support.py` | `_summarize_apply` | 1352 | 143L |

### Top 15 fonctions à paramètres nombreux (≥ 10)

| Fichier | Fonction | Ligne | Params |
|---------|----------|-------|--------|
| `cinesort/app/plan_support.py` | `_build_resolved_row` | 1376 | 20 |
| `cinesort/domain/quality_score.py` | `_build_quality_metrics_helper` | 1176 | 19 |
| `cinesort/app/plan_support.py` | `_build_unresolved_row` | 1259 | 17 |
...
| `cinesort/app/plan_support.py` | `_plan_item` | 1580 | 13 |
| `cinesort/ui/api/apply_support.py` | `_execute_apply` | 1032 | 13 |
| `cinesort/ui/api/apply_support.py` | `_summarize_apply` | 1352 | 13 |
| `cinesort/app/apply_core.py` | `move_file_with_collision_policy` | 481 | 12 |
| `cinesort/app/apply_core.py` | `merge_dir_safe` | 637 | 12 |
| `cinesort/app/plan_support.py` | `_plan_single` | 1764 | 12 |
| `cinesort/app/plan_support.py` | `_plan_collection_item` | 1796 | 12 |
| `cinesort/domain/core.py` | `build_plan_note` | 952 | 12 |
