...
| Métrique | Valeur |
|----------|--------|
| Fichiers Python (cinesort/) | 140 |
| LOC Python total | 47,209 |
| Fichiers JS (web/) | 124 |
| LOC JS total | 32,372 |
...
| Métrique | Valeur |
|----------|--------|
| Fonctions test_* totales | 4243 |
| Tests skip cumulés (@skip / @unittest.skip) | 38 |
...
|------------|-------------|------------|
| `BLE001` | blind except (`except Exception`) | 22 |
| `PLR2004` | magic value comparison | 278 |
| `PLR0913` | too many arguments (>5) | 120 |
| `C901` | complexity > 10 | 84 |
| `SIM105` | try/except/pass → suppress | 0 |
| `ARG001` | argument inutilisé | 35 |
| `B007` | variable de boucle inutilisée | 1 |
| `RUF100` | `# noqa` inutile | 1 |

## Anti-patterns mesurés par AST

| Métrique | Valeur |
|----------|--------|
| `except Exception` / bare except | **24** |
| Fonctions > 100L | **48** |
| Fonctions > 150L | **17** |
| Fonctions avec ≥ 10 paramètres | **30** |
| Imports lazy (`import cinesort.X` indenté) | **162** |
...
| `cinesort/app/apply_core.py` | `apply_rows` | 783 | **271L** |
| `cinesort/ui/api/apply_support.py` | `_execute_apply` | 1033 | **225L** |
| `cinesort/ui/api/dashboard_support.py` | `_build_dashboard_section` | 184 | **212L** |
| `cinesort/ui/api/apply_support.py` | `_execute_undo_ops` | 284 | **207L** |
| `cinesort/app/plan_support.py` | `_plan_item` | 1575 | **182L** |
| `cinesort/domain/quality_score.py` | `compute_quality_score` | 1252 | **181L** |
...
| `cinesort/domain/quality_score.py` | `_score_video` | 441 | **178L** |
...
| `cinesort/app/apply_core.py` | `move_file_with_collision_policy` | 481 | **154L** |
| `cinesort/ui/api/perceptual_support.py` | `_video_task` | 152 | **153L** |
| `cinesort/ui/api/apply_support.py` | `apply_changes` | 1635 | **152L** |
...
| `cinesort/ui/api/perceptual_support.py` | `_video_task` | 152 | 153L |
| `cinesort/ui/api/apply_support.py` | `apply_changes` | 1635 | 152L |
| `cinesort/ui/api/dashboard_support.py` | `get_global_stats` | 1181 | 152L |
| `cinesort/ui/api/apply_support.py` | `build_apply_preview` | 1852 | 151L |
| `cinesort/ui/api/run_flow_support.py` | `_build_plan_job_fn` | 324 | 148L |
| `cinesort/app/job_runner.py` | `_run_worker` | 186 | 144L |
| `cinesort/ui/api/apply_support.py` | `_summarize_apply` | 1351 | 143L |

### Top 15 fonctions à paramètres nombreux (≥ 10)

| Fichier | Fonction | Ligne | Params |
|---------|----------|-------|--------|
| `cinesort/app/plan_support.py` | `_build_resolved_row` | 1371 | 20 |
| `cinesort/domain/quality_score.py` | `_build_quality_metrics_helper` | 1170 | 19 |
| `cinesort/app/plan_support.py` | `_build_unresolved_row` | 1256 | 17 |
| `cinesort/infra/db/_perceptual_mixin.py` | `upsert_perceptual_report` | 19 | 17 |
| `cinesort/app/apply_core.py` | `apply_single` | 1056 | 15 |
| `cinesort/app/apply_core.py` | `apply_collection_item` | 1182 | 15 |
| `cinesort/domain/perceptual/comparison.py` | `extract_aligned_frames` | 32 | 14 |
| `cinesort/app/plan_support.py` | `_plan_item` | 1575 | 13 |
| `cinesort/ui/api/apply_support.py` | `_execute_apply` | 1033 | 13 |
| `cinesort/ui/api/apply_support.py` | `_summarize_apply` | 1351 | 13 |
| `cinesort/app/apply_core.py` | `move_file_with_collision_policy` | 481 | 12 |
| `cinesort/app/apply_core.py` | `merge_dir_safe` | 637 | 12 |
| `cinesort/app/plan_support.py` | `_plan_single` | 1759 | 12 |
| `cinesort/app/plan_support.py` | `_plan_collection_item` | 1791 | 12 |
| `cinesort/domain/core.py` | `build_plan_note` | 949 | 12 |
...
| `cinesort/ui/api/apply_support.py` | 2 |
...
| `cinesort/app/plan_support.py` | 2045 |
| `cinesort/ui/api/apply_support.py` | 2003 |
| `cinesort/ui/api/settings_support.py` | 1491 |
| `cinesort/domain/core.py` | 1477 |
| `cinesort/app/apply_core.py` | 1470 |
| `cinesort/domain/quality_score.py` | 1433 |
| `cinesort/ui/api/dashboard_support.py` | 1405 |
| `cinesort/infra/rest_server.py` | 1048 |
| `cinesort/ui/api/run_flow_support.py` | 878 |
| `cinesort/infra/tmdb_client.py` | 811 |
...
| `cinesort/domain/perceptual/grain_analysis.py` | 534 |
