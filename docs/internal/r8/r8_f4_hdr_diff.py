...
def run():
    ...
    results["R8043_todict_hdr_correct"] = d_hdr["hdr_analysis"] == {"hdr_format": "hdr10", "is_hdr": True} and d_sdr[
        "hdr_analysis"
    ] == {"hdr_format": "sdr", "is_hdr": False}
    ...
    results["R8043_modal_hdr_shown"] = (
        avant_render == "sdr" and apres_render_hdr == "hdr10" and apres_render_sdr == "sdr"
    )
    ...
    print(
        "NOTE PLAN A : detect_hdr_type prouvé sur valeurs couleur réelles ; le wiring complet "
