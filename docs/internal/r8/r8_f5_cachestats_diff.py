...
from cinesort.app.plan_support_core import (
    stats_snapshot_for_cache, stats_delta_for_cache, stats_apply_cached_delta,
)

OMITTED = [
    "tv_episodes_seen", "root_level_films_seen", "films_rejected_ext",
    "films_rejected_size", "films_rejected_name", "folders_rejected_scandir_error",
]
...
def run():
    ...
    print(f"{'folders_scanned (témoin)':32} {cached.folders_scanned:>6} {avant.folders_scanned:>6} {apres.folders_scanned:>6}")
