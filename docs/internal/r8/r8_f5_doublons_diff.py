...
def run():
    ...
    store = types.SimpleNamespace(
        apply=types.SimpleNamespace(list_duplicate_decisions=lambda run_id: decisions)
    )
    data = {"groups": [
    ...
    print(f"  APRÈS groupe k1 : winner_decided={g0.get('winner_decided')} winner_side={g0.get('winner_side')} winner_row_id={g0.get('winner_row_id')}")
    ...
    probe = {"video": {"codec": "hevc", "width": 1920, "height": 1080},
