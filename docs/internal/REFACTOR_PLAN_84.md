...
Remesure sur l'arbre courant avant de coder : **22 statements** `import` situés dans
un corps de fonction et visant un module `cinesort.ui.api.*`. Le chiffre de
l'issue (89, daté du 2026-07-19) est périmé depuis longtemps ; la vague 1 en
comptait 59, la vague 2 en laissait 24.
